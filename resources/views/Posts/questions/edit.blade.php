...
<body class="logged-in admin-bar no-customize-support wpqa-edit-question main_for_all active-lightbox discy-not-boxed">
    ...
    <div class="discy-inner-content menu_sidebar">
        <div class="the-main-container">
			...
			<meta itemprop="position" content="1"><a itemprop="item" href="{{route('QuestionBody')}}" title="Home"><span itemprop="name"><i class="icon-home"></i>Questions</span></a></span><span class="crumbs-span">/</span><span class="current">Edit question</span></span>
                ...
                <aside class="sidebar sidebar-width float_l fixed-sidebar"></aside><!-- End sidebar -->
            </main><!-- End discy-site-content -->

            <nav class="nav_menu float_r fixed_nav_menu"></nav><!-- End nav_menu -->
