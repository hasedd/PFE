...
<body class="home page-template page-template-template-home page-template-template-home-php page page-id-64 logged-in admin-bar no-customize-support page-with-breadcrumbs main_for_all active-lightbox discy-not-boxed">
                ...
                <div class="right-header float_r">
                    <div class="user-login-area">
                        <div class="notifications-area user-notifications float_r">
                            ...
                            <i class="icon-bell"></i>
                            <div><ul><li><div>There are no notifications yet.</div></li></ul></div>								</div><!-- End user-notifications -->
                        <div class="user-login-click float_r">
                            <span class="user-click"></span>
                            <div class="user-image float_l">
                                <img class='avatar avatar-29 photo' alt='root' title='root' width='29' height='29' srcset='http://2.gravatar.com/avatar/eec3a616e54e25bb4c28e3f7d9380092?s=96&d=mm&r=g 1x, http://2.gravatar.com/avatar/eec3a616e54e25bb4c28e3f7d9380092?s=96&d=mm&r=g 2x' src='http://2.gravatar.com/avatar/eec3a616e54e25bb4c28e3f7d9380092?s=96&d=mm&r=g'>									</div>
                            <div class="user-login float_l">
                                <span>Welcome</span><br>
                                <div class="float_l">root</div>
                            </div>
                            <i class="icon-down-open-mini"></i>
                            <ul>
                                <li><a href="http://template.test/profile/root/"><i class="icon-user"></i>User Profile</a></li>
                                <li><a href="http://template.test/profile/root/edit/"><i class="icon-pencil"></i>Edit Profile</a></li>
                                <li>
                                    <a href="http://template.test/profile/root/pending-questions/">
                                        <i class="icon-book-open"></i>Pending Questions															</a>
                                </li>
                                <li>
                                    <a href="http://template.test/profile/root/messages/">
                                        <i class="icon-mail"></i>Messages															</a>
                                </li>
                                <li><a href="http://template.test/profile/root/groups/"><i class="icon-network"></i>Groups</a></li>
                                <li><a href="http://template.test/profile/root/referrals/"><i class="icon-user-add"></i>Referrals</a></li>
                                <li><a href="http://template.test/profile/root/asked-questions/"><i class="icon-sound"></i>Asked Questions</a></li>
                                <li><a href="http://template.test/profile/root/best-answers/"><i class="icon-graduation-cap"></i>Best Answers</a></li>
                                <li><a href="http://template.test/profile/root/points/"><i class="icon-bucket"></i>Points</a></li>
                                <li><a href="http://template.test/profile/root/activities/"><i class="icon-chart-line"></i>Activity Log</a></li>
                                <li><a href="Dassets/wp-login.php?action=logout&amp;redirect_to=http%3A%2F%2Ftemplate.test%2F&amp;_wpnonce=11eb7ca8f1"><i class="icon-logout"></i>Log out</a></li>
                            </ul>
                        </div><!-- End user-login-click -->
                    </div><!-- End user-login-area -->
                </div><!-- End right-header -->
                <div class="left-header float_l">
                    <h2 class="screen-reader-text site_logo">Template</h2>
                    <a class="logo float_l logo-img" href="http://template.test/" title="Template">
                        <img title="Template" height="45" width="137" class="default_screen" alt="Template Logo" src="https://2code.info/demo/themes/Discy/Main/wp-content/themes/discy/images/logo.png">
                        <img title="Template" height="45" width="137" class="retina_screen" alt="Template Logo" src="https://2code.info/demo/themes/Discy/Main/wp-content/themes/discy/images/logo-2x.png">
                    </a>
                    <div class="mid-header float_l">
                        <div class="header-search float_r">
                            <form role="search" class="searchform main-search-form" method="get" action="http://template.test/search/">
                        ...
                        <nav class="nav float_l" itemscope="" itemtype="https://schema.org/SiteNavigationElement">
                            <h3 class="screen-reader-text">Template Navigation</h3>
                            <ul id="menu-header-login" class="menu"><li id="menu-item-80" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-64 current_page_item menu-item-80"><a class=""  href="http://template.test/">Home</a></li>
                                <li id="menu-item-81" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-81"><a class=""  href="http://template.test/about-us/">About Us</a></li>
                                <li id="menu-item-82" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-82"><a class=""  href="http://template.test/blog/">Blog</a></li>
                                <li id="menu-item-210" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-210"><a class=""  href="http://template.test/blog/">Blog</a></li>
                                <li id="menu-item-84" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-84"><a class=""  href="http://template.test/contact-us/">Contact Us</a></li>
                            </ul>							</nav><!-- End nav -->
                    </div><!-- End mid-header -->
                </div><!-- End left-header -->
                ...
                <div class="mobile-bar-content">
                    <div class="the-main-container">
                        <div class="mobile-bar-search">
                            <a href="http://template.test/search/"><i class="icon-search"></i>Search</a>
                            <form role="search" method="get" class="searchform main-search-form" action="http://template.test/search/">
                        ...
                        <div class="mobile-bar-ask">
                            <a target="_self" class="wpqa-question " href="http://template.test/add-question/"><i class="icon-help-circled"></i>Ask A Question</a>
                        </div>
                    </div><!-- End the-main-container -->
            ...
            <div class="mobile-aside-inner-inner">
                ...
                <div class="mobile-menu-top mobile--top">
                    <div class="widget widget_ask">
                        <a href="http://template.test/add-question/" class="button-default wpqa-question">Ask a Question</a>
                    </div>
                </div><!-- End mobile-menu-top -->
                <ul id="nav_menu" class="menu"><li id="menu-item-71" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-71"><a class=""  href="http://template.test/users/">Meet The Team</a></li>
                    <li id="menu-item-200" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-200"><a class=""  href="http://template.test/users/">Meet The Team</a></li>
                    <li id="menu-item-243" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-243"><a class=""  href="http://template.test/users/">Meet The Team</a></li>
                    <li id="menu-item-72" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-72"><a class=""  href="http://template.test/blog/">Blog</a></li>
                    <li id="menu-item-201" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-201"><a class=""  href="http://template.test/blog/">Blog</a></li>
                    <li id="menu-item-244" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-244"><a class=""  href="http://template.test/blog/">Blog</a></li>
                    <li id="menu-item-73" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-73"><a class=""  href="http://template.test/about-us/">About Us</a></li>
                    <li id="menu-item-202" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-202"><a class=""  href="http://template.test/about-us/">About Us</a></li>
                    <li id="menu-item-245" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-245"><a class=""  href="http://template.test/about-us/">About Us</a></li>
                    <li id="menu-item-74" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-74"><a class=""  href="http://template.test/contact-us/">Contact Us</a></li>
                    <li id="menu-item-203" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-203"><a class=""  href="http://template.test/contact-us/">Contact Us</a></li>
                    <li id="menu-item-246" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-246"><a class=""  href="http://template.test/contact-us/">Contact Us</a></li>
            ...
            <div class="the-main-container">
				...
				No Answers					</option>
                    ...
                    <aside class="sidebar sidebar-width float_l fixed-sidebar">
                        ...
                        <div class="inner-sidebar">
                            <div class="widget widget_ask">
                                <a target="_self" href="http://template.test/add-question/" class="button-default wpqa-question">Ask A Question</a>		</div>
                            <section id="stats-widget-7" class="widget-no-divider widget stats-widget"><h3 class='screen-reader-text'>Stats</h3>			<div class="widget-wrap">
                                ...
                                <div class="widget-wrap">
                                    <div class='widget-posts tab-inner-wrap tab-inner-wraptabs-widget-4'><div class="user-notifications user-profile-area">
                                            <div>
                                                <ul><li class="widget-posts-text widget-no-img"><span class="span-icon"><a href="http://template.test/profile/root/"><img class='avatar avatar-20 photo' alt='root' title='root' width='20' height='20' srcset='http://2.gravatar.com/avatar/eec3a616e54e25bb4c28e3f7d9380092?s=96&d=mm&r=g 1x, http://2.gravatar.com/avatar/eec3a616e54e25bb4c28e3f7d9380092?s=96&d=mm&r=g 2x' src='http://2.gravatar.com/avatar/eec3a616e54e25bb4c28e3f7d9380092?s=96&d=mm&r=g'></a></span><div><h3><a href="http://template.test/question/how-to-approach-applying-for-a-job-at-a-company-owned-by-a-friend/" title="How to approach applying for a job at a company owned by a friend?" rel="bookmark">How to approach applying for a job at a company ...</a></h3><ul class="widget-post-meta"><li><a class="post-meta-comment" href="http://template.test/question/how-to-approach-applying-for-a-job-at-a-company-owned-by-a-friend/#comments"><i class="icon-comment"></i>7 Answers</a></li></ul></div>
                                                    </li><li class="widget-posts-text widget-no-img"><span class="span-icon"><a href="http://template.test/profile/root/"><img class='avatar avatar-20 photo' alt='root' title='root' width='20' height='20' srcset='http://2.gravatar.com/avatar/eec3a616e54e25bb4c28e3f7d9380092?s=96&d=mm&r=g 1x, http://2.gravatar.com/avatar/eec3a616e54e25bb4c28e3f7d9380092?s=96&d=mm&r=g 2x' src='http://2.gravatar.com/avatar/eec3a616e54e25bb4c28e3f7d9380092?s=96&d=mm&r=g'></a></span><div><h3><a href="http://template.test/question/why-are-the-british-confused-about-us-calling-bread-rolls-biscuits-when-they-call-bread-rolls-puddings/" title="Why are the British confused about us calling bread rolls “biscuits” when they call bread rolls “puddings”?" rel="bookmark">Why are the British confused about us calling bread rolls ...</a></h3><ul class="widget-post-meta"><li><a class="post-meta-comment" href="http://template.test/question/why-are-the-british-confused-about-us-calling-bread-rolls-biscuits-when-they-call-bread-rolls-puddings/#comments"><i class="icon-comment"></i>5 Answers</a></li></ul></div>
                                                    </li><li class="widget-posts-text widget-no-img"><span class="span-icon"><a href="http://template.test/profile/root/"><img class='avatar avatar-20 photo' alt='root' title='root' width='20' height='20' srcset='http://2.gravatar.com/avatar/eec3a616e54e25bb4c28e3f7d9380092?s=96&d=mm&r=g 1x, http://2.gravatar.com/avatar/eec3a616e54e25bb4c28e3f7d9380092?s=96&d=mm&r=g 2x' src='http://2.gravatar.com/avatar/eec3a616e54e25bb4c28e3f7d9380092?s=96&d=mm&r=g'></a></span><div><h3><a href="http://template.test/question/how-to-handle-personal-stress-caused-by-utterly-incompetent-and-lazy-co-workers/" title="How to handle personal stress caused by utterly incompetent and lazy co-workers?" rel="bookmark">How to handle personal stress caused by utterly incompetent and ...</a></h3><ul class="widget-post-meta"><li><a class="post-meta-comment" href="http://template.test/question/how-to-handle-personal-stress-caused-by-utterly-incompetent-and-lazy-co-workers/#comments"><i class="icon-comment"></i>5 Answers</a></li></ul></div>
                                                    </li></ul></div>
                            ...
                            <section id="activities-widget-4" class="widget activities-widget"><h2 class="widget-title"><i class="icon-folder"></i>Recent Activities</h2>				<div class="widget-wrap">
                                    <div class="user-notifications user-profile-area">
                                        <div>
                                            <ul><li><div>There are no activities yet.</div></li></ul></div>				    </div><!-- End user-notifications -->
                                </div>
                            </section><section id="users-widget-4" class="widget users-widget"><h2 class="widget-title"><i class="icon-folder"></i>Top Members</h2>				<div class="widget-wrap">
                                    <div class='user-section user-section-small row user-not-normal'>					</div>
                                </div>
                            </section><section id="tag_cloud-4" class="widget widget_tag_cloud"><h2 class="widget-title"><i class="icon-folder"></i>Trending Tags</h2><div class="tagcloud"><a href="http://template.test/question-tag/analytics/" class="tag-cloud-link tag-link-4 tag-link-position-1" style="font-size: 22pt;" aria-label="analytics (3 items)">analytics</a>
                                    ...
                                    <a href="http://template.test/question-tag/university/" class="tag-cloud-link tag-link-31 tag-link-position-21" style="font-size: 8pt;" aria-label="university (1 item)">university</a></div>
                            </section>								</div>
                    </aside><!-- End sidebar -->
                ...
                <nav class="nav_menu float_r fixed_nav_menu">
                    ...
                    <ul id="menu-explore" class="menu"><li id="menu-item-90" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-64 current_page_item menu-item-90"><a class=""  href="http://template.test/"><i class="icon-home"></i>Home</a></li>
                        ...
                        <li id="menu-item-178" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-178"><a class=""  href="http://template.test/groups-page/"><i class="icon-globe"></i>Groups page</a></li>
                        <li id="menu-item-91" class="wpqa-menu wpqa-profile-nav menu-item menu-item-type-custom menu-item-object-custom menu-item-91 li-profile"><a class=""  href="http://template.test/profile/root/"><i class="icon-vcard"></i>User Profile</a></li>
                        <li id="menu-item-93" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-93"><a class=""  href="http://template.test/communities/"><i class="icon-folder"></i>Communities</a></li>
                        <li id="menu-item-94" class="nav_menu_open menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-94"><a class=""  href="http://template.test/questions/"><i class="icon-book-open"></i>Questions</a>
                            <ul class="sub-menu">
                                <li id="menu-item-95" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-95"><a class=""  href="http://template.test/?show=recent-questions">New Questions</a></li>
                                <li id="menu-item-96" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-96"><a class=""  href="http://template.test/?show=most-voted">Trending Questions</a></li>
                                <li id="menu-item-97" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-97"><a class=""  href="http://template.test/?show=most-visited">Must read Questions</a></li>
                                <li id="menu-item-98" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-98"><a class=""  href="http://template.test/?show=most-answered">Hot Questions</a></li>
                            </ul>
                        </li>
                        <li id="menu-item-126" class="wpqa-menu wpqa-poll-nav menu-item menu-item-type-custom menu-item-object-custom menu-item-126 li-poll"><a class=""  href="http://template.test/questions/?type=poll"><i class="icon-megaphone"></i>Polls</a></li>
                        <li id="menu-item-100" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-100"><a class=""  href="http://template.test/tags/"><i class="icon-tag"></i>Tags</a></li>
                        ...
                        <li id="menu-item-101" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-101"><a class=""  href="http://template.test/users/"><i class="icon-users"></i>Users</a></li>
                        <li id="menu-item-170" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-170"><a class=""  href="http://template.test/questions-feed/"><i class="icon-newspaper"></i>Feed</a></li>
                        <li id="menu-item-103" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-103"><a class=""  href="http://template.test/faqs/"><i class="icon-lifebuoy"></i>Help</a></li>
                        <li id="menu-item-173" class="wpqa-menu wpqa-buy-points-nav menu-item menu-item-type-custom menu-item-object-custom menu-item-173 li-buy-points"><a class=""  href="http://template.test/buy-points/"><i class="icon-star"></i>Buy Points</a></li>
                        <li id="menu-item-172" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-172"><a class=""  target="_blank" href="https://1.envato.market/drV57"><i class="icon-basket"></i>Buy Theme</a></li>
                    </ul>						</nav><!-- End nav_menu -->
            </div><!-- End the-main-container -->
                        ...
                        <div class="col4">
                            <section id="about-widget-4" class="widget about-widget">			<div class="widget-wrap">
                                    <div class="about-image about-image-text" style='margin-top:50px'>
                                        <img src="https://2code.info/demo/themes/Discy/Main/wp-content/themes/discy/images/logo-footer.png" alt="Template">
                                    </div>
                                    <div class="about-text">
                                        <div class='empty-title'><h2 class="widget-title"><i class="icon-folder"></i></h2></div>Discy is a social questions &amp; Answers Engine which will help you establis your community and connect with other people.				</div>
                                </div>
                            </section>											</div>

                        <div class="col2">
                            <section id="nav_menu-10" class="widget widget_nav_menu"><h2 class="widget-title"><i class="icon-folder"></i>About Us</h2><div class="menu-company-container"><ul id="menu-company" class="menu"><li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-71"><a class=""  href="http://template.test/users/">Meet The Team</a></li>
                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-200"><a class=""  href="http://template.test/users/">Meet The Team</a></li>
                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-243"><a class=""  href="http://template.test/users/">Meet The Team</a></li>
                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-72"><a class=""  href="http://template.test/blog/">Blog</a></li>
                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-201"><a class=""  href="http://template.test/blog/">Blog</a></li>
                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-244"><a class=""  href="http://template.test/blog/">Blog</a></li>
                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-73"><a class=""  href="http://template.test/about-us/">About Us</a></li>
                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-202"><a class=""  href="http://template.test/about-us/">About Us</a></li>
                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-245"><a class=""  href="http://template.test/about-us/">About Us</a></li>
                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-74"><a class=""  href="http://template.test/contact-us/">Contact Us</a></li>
                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-203"><a class=""  href="http://template.test/contact-us/">Contact Us</a></li>
                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-246"><a class=""  href="http://template.test/contact-us/">Contact Us</a></li>
                                    </ul></div></section>												</div>
                        <div class="col2">
                            <section id="nav_menu-11" class="widget widget_nav_menu"><h2 class="widget-title"><i class="icon-folder"></i>Legal Stuff</h2><div class="menu-legal-stuff-container"><ul id="menu-legal-stuff" class="menu"><li id="menu-item-257" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-257"><a class=""  href="http://template.test/faqs/">Terms of Use</a></li>
                                        <li id="menu-item-87" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-87"><a class=""  href="http://template.test/faqs/">Terms of Use</a></li>
                                        <li id="menu-item-214" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-214"><a class=""  href="http://template.test/faqs/">Terms of Use</a></li>
                                        <li id="menu-item-258" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-258"><a class=""  href="http://template.test/faqs/">Privacy Policy</a></li>
                                        <li id="menu-item-88" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-88"><a class=""  href="http://template.test/faqs/">Privacy Policy</a></li>
                                        <li id="menu-item-215" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-215"><a class=""  href="http://template.test/faqs/">Privacy Policy</a></li>
                                        <li id="menu-item-259" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-259"><a class=""  href="http://template.test/faqs/">Cookie Policy</a></li>
                                        <li id="menu-item-89" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-89"><a class=""  href="http://template.test/faqs/">Cookie Policy</a></li>
                                        <li id="menu-item-216" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-216"><a class=""  href="http://template.test/faqs/">Cookie Policy</a></li>
                                    </ul></div></section>												</div>
                        <div class="col2">
                            <section id="nav_menu-12" class="widget widget_nav_menu"><h2 class="widget-title"><i class="icon-folder"></i>Help</h2><div class="menu-help-container"><ul id="menu-help" class="menu"><li id="menu-item-256" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-256"><a class=""  href="http://template.test/faqs/">Knowledge Base</a></li>
                                        <li id="menu-item-86" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-86"><a class=""  href="http://template.test/faqs/">Knowledge Base</a></li>
                                        <li id="menu-item-213" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-213"><a class=""  href="http://template.test/faqs/">Knowledge Base</a></li>
                                        <li id="menu-item-85" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-85"><a class=""  href="http://template.test/contact-us/">Support</a></li>
                                        <li id="menu-item-212" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-212"><a class=""  href="http://template.test/contact-us/">Support</a></li>
                                        <li id="menu-item-255" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-255"><a class=""  href="http://template.test/contact-us/">Support</a></li>
                                    </ul></div></section>												</div>
                        <div class="col2">
                            <section id="social-widget-4" class="widget social-widget"><h2 class="widget-title"><i class="icon-folder"></i>Follow</h2>			<div class="widget-wrap">
                                    <ul class="social-ul">
                                        ...
                                        <li class="social-rss"><a title="Feed" href="http://template.test/feed/" target="_blank"><i class="icon-rss"></i></a></li>
                                    </ul>
                                </div>
                            </section>												</div>
                    </aside>
