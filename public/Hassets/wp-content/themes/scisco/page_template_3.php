...
<main id="scisco-main-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 <?php if ( is_active_sidebar( 'scisco_page_sidebar' ) ) { ?>col-xl-9<?php } ?>">
            ...
            <?php if ( is_active_sidebar( 'scisco_page_sidebar' ) ) { ?>
            <aside class="col-12 col-xl-3 mt-5 mt-xl-0">
                <?php dynamic_sidebar( 'scisco_page_sidebar' ); ?>
            </aside>
            <?php } ?>
        </div>
    </div>
